...
2. Watch a video lecture on logistic regression coming in 2 parts:
 - [theory](https://youtu.be/ne-MfRfYs_c) behind lLASSO and Ridge regression models
...
3. Watch a video lecture on regression and regularization coming in 2 parts:
 - [theory](https://www.youtube.com/watch?v=l3jiw-N544s) behind linear models, an intuitive explanation
